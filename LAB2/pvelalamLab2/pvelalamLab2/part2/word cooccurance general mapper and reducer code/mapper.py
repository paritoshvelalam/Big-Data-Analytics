...
# top20 is the list of top 20 words obtained from word count. This is different for each subtopic and data source
top20 = ['game', 'team', 'season', 'player', 'point', 'year', 'play', 'one', 'nba', 'sport', 'time', 'first', 'coach', 'bet', 'win', 'new', 'state', 'two', 'leagu', 'basketball']
